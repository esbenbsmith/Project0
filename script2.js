$(function() {
  ...
  ToDo.all = [
    new ToDo('I drank 4 gallons of coca-cola last night', 'Bad diet choices'),
    new ToDo('I intentionally talk weird to avoid people', 'lifehacks'),
    new ToDo('I have 2 families', 'Fucked up life!')
  ];
